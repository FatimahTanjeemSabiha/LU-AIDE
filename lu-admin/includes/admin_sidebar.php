        ...
        <li class="nav-item">
            ...
            <div id="department" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="department_st.php?source=view_department">All Department</a>
                </div>
            </div>
        </li>
   <?php }
    ...
    <li class='nav-item'>
        ...
        <div id='contact' class='collapse' aria-labelledby='headingTwo' data-parent='#accordionSidebar'>
            <div class='bg-white py-2 collapse-inner rounded'>
                ...
                <a class='collapse-item' href="contact-forms.php?source=all_contact">All Contacts</a>
            </div>
        </div>
    </li>
